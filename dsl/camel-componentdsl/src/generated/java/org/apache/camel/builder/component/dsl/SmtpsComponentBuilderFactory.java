...
public interface SmtpsComponentBuilderFactory {
    ...
    interface SmtpsComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder generateMissingAttachmentNames(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder handleDuplicateAttachmentNames(
         ...
         * @return the dsl builder
         */
        default SmtpsComponentBuilder session(jakarta.mail.Session session) {
