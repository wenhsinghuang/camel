...
public interface StringTemplateComponentBuilderFactory {
     ...
     */
    interface StringTemplateComponentBuilder
            extends
                ComponentBuilder<StringTemplateComponent> {
        /**
    ...
    class StringTemplateComponentBuilderImpl
            extends
                AbstractComponentBuilder<StringTemplateComponent>
            implements
                StringTemplateComponentBuilder {
        @Override
        protected StringTemplateComponent buildConcreteComponent() {
            return new StringTemplateComponent();
        }
        @Override
