...
public interface CoapsTcpComponentBuilderFactory {
     ...
     */
    static CoapsTcpComponentBuilder coapsTcp() {
        return new CoapsTcpComponentBuilderImpl();
    }

    /**
     * Builder for the CoAP component.
     */
    interface CoapsTcpComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default CoapsTcpComponentBuilder autowiredEnabled(
