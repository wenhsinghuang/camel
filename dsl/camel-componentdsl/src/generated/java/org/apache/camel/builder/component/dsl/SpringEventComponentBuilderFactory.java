...
public interface SpringEventComponentBuilderFactory {
     ...
     */
    interface SpringEventComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default SpringEventComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default SpringEventComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default SpringEventComponentBuilder autowiredEnabled(
    ...
    class SpringEventComponentBuilderImpl
            extends
                AbstractComponentBuilder<EventComponent>
            implements
