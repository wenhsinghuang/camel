...
public interface GoogleSecretManagerComponentBuilderFactory {
    ...
    class GoogleSecretManagerComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "lazyStartProducer": ((GoogleSecretManagerComponent) component).setLazyStartProducer((boolean) value); return true;
            case "autowiredEnabled": ((GoogleSecretManagerComponent) component).setAutowiredEnabled((boolean) value); return true;
