...
public interface CouchbaseComponentBuilderFactory {
     ...
     */
    static CouchbaseComponentBuilder couchbase() {
        return new CouchbaseComponentBuilderImpl();
    }

    /**
     * Builder for the Couchbase component.
     */
    interface CouchbaseComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default CouchbaseComponentBuilder autowiredEnabled(
    ...
    class CouchbaseComponentBuilderImpl
            extends
                AbstractComponentBuilder<CouchbaseComponent>
            implements
                CouchbaseComponentBuilder {
        @Override
