...
public interface CouchdbComponentBuilderFactory {
     ...
     */
    interface CouchdbComponentBuilder
            extends
    ...
    class CouchdbComponentBuilderImpl
            extends
                AbstractComponentBuilder<CouchDbComponent>
            implements
                CouchdbComponentBuilder {
        @Override
        protected CouchDbComponent buildConcreteComponent() {
            return new CouchDbComponent();
        }
        @Override
