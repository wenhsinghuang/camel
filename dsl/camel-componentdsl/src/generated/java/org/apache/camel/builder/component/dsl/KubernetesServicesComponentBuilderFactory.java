...
public interface KubernetesServicesComponentBuilderFactory {
     ...
     */
    static KubernetesServicesComponentBuilder kubernetesServices() {
        return new KubernetesServicesComponentBuilderImpl();
    }
    ...
    interface KubernetesServicesComponentBuilder
         ...
         * @return the dsl builder
         */
        default KubernetesServicesComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default KubernetesServicesComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default KubernetesServicesComponentBuilder autowiredEnabled(
    ...
    class KubernetesServicesComponentBuilderImpl
            extends
                AbstractComponentBuilder<KubernetesServicesComponent>
            implements
                KubernetesServicesComponentBuilder {
        @Override
        protected KubernetesServicesComponent buildConcreteComponent() {
            return new KubernetesServicesComponent();
        }
        @Override
