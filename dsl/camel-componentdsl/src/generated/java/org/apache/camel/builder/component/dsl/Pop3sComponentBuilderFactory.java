...
public interface Pop3sComponentBuilderFactory {
    ...
    interface Pop3sComponentBuilder extends ComponentBuilder<MailComponent> {
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder generateMissingAttachmentNames(
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder handleDuplicateAttachmentNames(
         ...
         * @return the dsl builder
         */
        default Pop3sComponentBuilder session(jakarta.mail.Session session) {
