...
public interface OpenstackNovaComponentBuilderFactory {
     ...
     */
    interface OpenstackNovaComponentBuilder
            extends
                ComponentBuilder<NovaComponent> {
        /**
         ...
         * @return the dsl builder
         */
        default OpenstackNovaComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default OpenstackNovaComponentBuilder autowiredEnabled(
    ...
    class OpenstackNovaComponentBuilderImpl
            extends
                AbstractComponentBuilder<NovaComponent>
            implements
