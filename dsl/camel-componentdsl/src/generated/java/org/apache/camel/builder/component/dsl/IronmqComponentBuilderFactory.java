...
public interface IronmqComponentBuilderFactory {
     ...
     */
    static IronmqComponentBuilder ironmq() {
        return new IronmqComponentBuilderImpl();
    }

    /**
     * Builder for the IronMQ component.
     */
    interface IronmqComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default IronmqComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
    ...
    class IronmqComponentBuilderImpl
            extends
                AbstractComponentBuilder<IronMQComponent>
            implements
                IronmqComponentBuilder {
        @Override
