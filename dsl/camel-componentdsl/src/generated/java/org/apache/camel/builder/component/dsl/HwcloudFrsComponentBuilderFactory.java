...
public interface HwcloudFrsComponentBuilderFactory {
    ...
    class HwcloudFrsComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
                ...
                Object value) {
            switch (name) {
            case "lazyStartProducer": ((FaceRecognitionComponent) component).setLazyStartProducer((boolean) value); return true;
            case "autowiredEnabled": ((FaceRecognitionComponent) component).setAutowiredEnabled((boolean) value); return true;
