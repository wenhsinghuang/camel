...
public interface HazelcastMultimapComponentBuilderFactory {
     ...
     */
    interface HazelcastMultimapComponentBuilder
            extends
    ...
    class HazelcastMultimapComponentBuilderImpl
            extends
                AbstractComponentBuilder<HazelcastMultimapComponent>
            implements
                HazelcastMultimapComponentBuilder {
        @Override
        protected HazelcastMultimapComponent buildConcreteComponent() {
            return new HazelcastMultimapComponent();
        }
        @Override
