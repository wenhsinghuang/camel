...
public interface SpringRedisComponentBuilderFactory {
     ...
     */
    static SpringRedisComponentBuilder springRedis() {
     ...
     */
    interface SpringRedisComponentBuilder
            extends
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder bridgeErrorHandler(
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default SpringRedisComponentBuilder autowiredEnabled(
    ...
    class SpringRedisComponentBuilderImpl
            extends
                AbstractComponentBuilder<RedisComponent>
            implements
                SpringRedisComponentBuilder {
        @Override
