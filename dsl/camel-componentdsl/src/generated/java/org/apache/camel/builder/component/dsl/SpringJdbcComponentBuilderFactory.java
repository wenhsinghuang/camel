...
public interface SpringJdbcComponentBuilderFactory {
     ...
     */
    static SpringJdbcComponentBuilder springJdbc() {
        return new SpringJdbcComponentBuilderImpl();
    }

    /**
     * Builder for the Spring JDBC component.
     */
    interface SpringJdbcComponentBuilder
            extends
                ComponentBuilder<SpringJdbcComponent> {
        /**
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder dataSource(
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder lazyStartProducer(
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder autowiredEnabled(
         ...
         * @return the dsl builder
         */
        default SpringJdbcComponentBuilder connectionStrategy(
    ...
    class SpringJdbcComponentBuilderImpl
            extends
                AbstractComponentBuilder<SpringJdbcComponent>
            implements
                SpringJdbcComponentBuilder {
        @Override
