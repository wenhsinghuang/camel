...
public interface XmppComponentBuilderFactory {
     ...
     */
    static XmppComponentBuilder xmpp() {
        return new XmppComponentBuilderImpl();
    }
    ...
    interface XmppComponentBuilder extends ComponentBuilder<XmppComponent> {
         ...
         * @return the dsl builder
         */
        default XmppComponentBuilder autowiredEnabled(boolean autowiredEnabled) {
            doSetProperty("autowiredEnabled", autowiredEnabled);
            return this;
        }
    }

    class XmppComponentBuilderImpl
            extends
                AbstractComponentBuilder<XmppComponent>
            implements
                XmppComponentBuilder {
        @Override
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "autowiredEnabled": ((XmppComponent) component).setAutowiredEnabled((boolean) value); return true;
